    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
      {products.map((product) => {
        ...
        return (
          ...
          >
            <div className="aspect-square overflow-hidden relative mb-3 rounded-2xl border-2 border-white/70 bg-white/10" style={{ boxShadow: '0 0 20px 6px rgba(202,201,249,0.25), 0 0 6px 2px rgba(202,201,249,0.35)' }}>
              {image ? (
                <Image
                  src={image.url}
