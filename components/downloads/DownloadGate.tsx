...
function DownloadCard({ item }: { item: DownloadItem }) {
  return (
    <div
      className="rounded-2xl border-2 border-white/70 bg-white/10 backdrop-blur-sm overflow-hidden"
      ...
      <div className="p-4">
        ...
        {item.downloadUrl && (
          <a
            ...
            className="mt-4 inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-bold uppercase tracking-widest border-2 border-white/70 bg-white/10 text-(--color-text-primary) hover:bg-white/20 transition-all duration-150"
